...
* **Step 12**: Create an [`InversifyProvider`](https://github.com/Xipooo/ReactDIDemo/blob/Step-12/ClientApp/src/providers/InversifyProvider.tsx) Wrapper Component to inject a React Context into a child component.